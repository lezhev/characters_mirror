...
CREATE TABLE "class_feature_data" (
    ...
    "choiceGroupKey" text,
    "relatedTable" text,
    "resourceResetOn" text,
    "resourceMaxRule" text,
    "resourceMaxValue" bigint,
    "resourceMaxAbility" text
);
...
--
-- Class FeatureResourceLevelData as table feature_resource_level_data
--
...
--
-- Foreign relations for "feature_resource_level_data" table
--

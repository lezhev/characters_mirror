...
CREATE TABLE "race_choice_set_data" (
    ...
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone,
    "_raceDataChoicesetsRaceDataId" bigint,
    "_raceFeatureDataChoicesetsRaceFeatureDataId" bigint,
    "_subraceDataChoicesetsSubraceDataId" bigint
);
...
CREATE TABLE "race_feature_spell_grant_data" (
    ...
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone,
    "_raceFeatureDataSpellgrantsRaceFeatureDataId" bigint
);

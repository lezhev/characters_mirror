...
CREATE TABLE "armor_data" (
    ...
    "cost" text,
    "_charactersArmorCharactersId" bigint
);
...
--
-- Class CharacterChoiceData as table character_choice_data
--
...
--
-- Class CharacterClassEntryData as table character_class_relation
--
...
--
-- Class CharacterSheetSnapshotData as table character_sheet_snapshot_data
--
...
CREATE TABLE "class_data" (
    ...
    "spellcastingProgression" bigint,
    "spellcastingAbility" text,
    "spellcastingAbilityValue" bigint,
...
CREATE TABLE "class_option_data" (
    ...
    "type" text,
    "isOptional" boolean,
    "_charactersVariantoptionsCharactersId" bigint
);

--
-- Class DragonbornAncestryData as table dragonborn_ancestry_data
--
...
CREATE TABLE "item_data" (
    ...
    "cost" bigint,
    "effects" json,
    "_charactersItemsCharactersId" bigint,
...
CREATE TABLE "magic_item_data" (
    ...
    "effects" json,
    "_charactersMagicitemsCharactersId" bigint
);
...
--
-- Class RaceOptionData as table race_option_data
--
...
CREATE TABLE "spell_data" (
    ...
    "_charactersPreparedspellsCharactersId" bigint,
    "_charactersWrittenspellsCharactersId" bigint
);
...
CREATE TABLE "weapon_data" (
    ...
    "damage" text,
    "damageType" text,
    "damageTypeValue" bigint,
    "properties" json,
    "weight" double precision,
    "cost" double precision,
    "rangeNormal" bigint,
    "rangeMax" bigint,
    "_charactersWeaponsCharactersId" bigint,
...
--
-- Foreign relations for "armor_data" table
--
...
--
-- Foreign relations for "character_sheet_snapshot_data" table
--
...
--
-- Foreign relations for "class_option_data" table
--
...
--
-- Foreign relations for "magic_item_data" table
--
...
--
-- Foreign relations for "race_option_data" table
--
...
--
-- Foreign relations for "spell_data" table
--

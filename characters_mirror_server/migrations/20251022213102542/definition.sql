...
--
-- Class AlignmentData as table alignment_data
--
CREATE TABLE "alignment_data" (
...
--
-- Class CharacterClassData as table class_data
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('characters_mirror', '20251022213102542', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251022213102542', "timestamp" = now();
